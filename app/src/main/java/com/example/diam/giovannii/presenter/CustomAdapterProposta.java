...
public class CustomAdapterProposta extends ArrayAdapter<PropostaEventoVisualizzata> {

    private int resource;
    private LayoutInflater inflater;

    public CustomAdapterProposta(Context c, int resourceId, ArrayList<PropostaEventoVisualizzata> props) {
    ...
    public View getView(int position, View v, ViewGroup parent) {
        ...
        if (v == null) {
            v = inflater.inflate(R.layout.list_element_proposta_evento, null);
        }
        ...
        nomeProposta = v.findViewById(R.id.textView_nome_proposta_evento);
