...
public class FragmentSingolaProposta extends Fragment {
    ...
    public FragmentSingolaProposta() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.pagina_proposta_evento, container, false);
        ...
        nomePropostaEvento = v.findViewById(R.id.textView_nome_proposta_evento_visualizzata);
        nomeLocalePropostaEvento = v.findViewById(R.id.textView_nome_locale_proposta_evento_visualizzato);

        viaPropostaEvento = v.findViewById(R.id.textView_via_proposta_evento_visualizzata);
        cittaPropostaEvento = v.findViewById(R.id.textView_citta_proposta_evento_visualizzata);
        provinciaPropostaEvento = v.findViewById(R.id.textView_provincia_proposta_evento_visualizzata);
        regionePropostaEvento = v.findViewById(R.id.textView_regione_proposta_evento_visualizzata);

        giornoPropostaEvento = v.findViewById(R.id.textView_giorno_proposta_evento_visualizzata);
        mesePropostaEvento = v.findViewById(R.id.textView_mese_proposta_evento_visualizzata);
        annoPropostaEvento = v.findViewById(R.id.textView_anno_proposta_evento_visualizzata);

        genereMusicaleRichiesto = v.findViewById(R.id.list_view_generi_musicali_proposta_evento);

        infoPropostaEvento = v.findViewById(R.id.textView_descrizione_proposta_evento_visualizzata);
        ...
        oraPropostaEvento = v.findViewById(R.id.textView_ora_proposta_evento_visualizzata);
        minutiPropostaEvento = v.findViewById(R.id.textView_minuti_proposta_evento_visualizzati);
            ...
            try {
                ...
                for (int j = 0; j < eventiPromotore.length(); j++) {
                    if (eventiPromotore.getJSONObject(j).getInt("idPropostaEvento") == idPropostaSelezionata) {
                        ...
                        System.out.println("NOOOOOOOOME" + nomeLocaleP);
